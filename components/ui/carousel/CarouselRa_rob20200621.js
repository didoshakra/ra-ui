      ...
      return (
        ...
        >
          ...
          <div className="testimony-item__wrap">
            ...
            <div className="testimony-item_text text-center">
              <p className="mb-5 pl-4 line">
                Far far away, behind the word mountains, far from the countries
                Vokalia and Consonantia, there live the blind texts.
              </p>
              <p className="testimony-item__text-name">Garreth Smith</p>
              <span className="testimony-item__text-position">
                Marketing Manager
              </span>
            </div>
          </div>
  ...
  return (
    <div className="ra-carousel">
      ...
      <style jsx global>{`
        ...
        .testimony-item__text-name {
          font-weight: 400;
          font-size: 18px;
          margin-bottom: 0;
          color: #000000;
        }
        .testimony-item__text-position {
          font-size: 12px;
          font-weight: 400;
