    ...
    <section className="footer-section">
      ...
      <div className="footer-context-row">
        ...
        <div className="footer-context-item-col">
          ...
          <h2 className="item__vegefoods-heading">Vegefoods</h2>
          <p>
          ...
          <ul className="footer-social">
            {/* <ul className="list-unstyled__social-icon"> */}
            {/* //list-unstyled {padding-left: 0;list-style: none;//float: left/mt-5=margin-top: 3rem */}
            <li>
              <a href="#">
                <span className="icon-social">
                  <IcontTwitter width="26" height="26" />
                </span>
              </a>
            </li>
            <li>
        ...
        <div className="footer-context-item-col">
          ...
          {/* //block-23 ul{padding: 0;} mb-3=margin-bottom: 1rem*/}
          <ul className="list-unstyled">
            <li>
