...
const translations = {
  en: {
    ...
    headerMenu_titlePromotions: "Promotions",
    ...
    pageHome_aboutPage: `Chain Stanislavsky.`,
  ...
  pl: {
    ...
    headerMenu_titleServices: "Usługi",
    headerMenu_titlePromocje: "Promocje",
    headerMenu_titleAboutME: "O nas",
  ...
  uk: {
    ...
    headerMenu_titleServices: "Послуги",
    headerMenu_titlePromotions: "Акції",
    headerMenu_titleAboutME: "Про нас",
