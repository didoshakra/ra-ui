...
const strings = {
  ...
  uk: {
    about: "Про Рене Магрітта",
    painting: "Картина",
    artist: "Артист",
    notAPipe: "Це не труба",
    bio: `Рене Франсуа Гіслен Магріт (21 листопада 1898 - 15 серпня 1967) був бельгійським художником-сюрреалістом. Він став відомим тим, що створив цілий ряд дотепних і вражаючих образів образів. Часто змальовуючи звичайні предмети у незвичному контексті, його роботи відомі складними попередньо обумовленими спостерігачами уявленнями про реальність. Його образність вплинула на поп-арт, мінімалістичне мистецтво та концептуальне мистецтво `,
    readMore: "Детальніше у Вікіпедії ..."
  }
};
